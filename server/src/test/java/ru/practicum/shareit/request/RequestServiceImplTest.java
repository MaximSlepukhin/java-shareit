...
public class RequestServiceImplTest {
    ...
    ItemRequestDtoOut itemRequestDtoFirstOut = ItemRequestDtoOut.builder().id(1L)
            .description("Хотел бы воспользоваться дрелью").build();
    ...
    void shouldCreateRequestTest() {
        ...
        Assertions.assertEquals(result.getDescription(), itemRequestDtoFirstOut.getDescription());
    }
    ...
    @Test
    void shouldSetItemsForRequests() {
    }*/
}
