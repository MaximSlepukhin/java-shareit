...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> updateItem(Map<String, String> itemUpdate, Long userId, Long itemId) {
        return patch("/" + itemId, userId, itemUpdate);
    }

    public ResponseEntity<Object> findItemById(Long itemId, Long userId, Integer from, Integer size) {
